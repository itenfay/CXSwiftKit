...
public class CXSKSvgaPlayManager: NSObject, CXSKSvgaPlayPresentable {
    
    @objc public static let shared = CXSKSvgaPlayManager()
...
extension CXSKSvgaPlayManager: SVGAPlayerDelegate {
